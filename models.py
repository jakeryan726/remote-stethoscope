...
class VAE(nn.Module):
    def __init__(self, latent_dim=128):
        ...
        self.decoder_conv3 = nn.ConvTranspose2d(32, 1, kernel_size=3, stride=2, padding=1, output_padding=1)
    ...
    def decode(self, z):
        ...
        z = z.view(z.size(0), 128, 32, 32)  # Reshape to (batch_size, channels, height, width)
